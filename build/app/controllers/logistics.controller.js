...
var _logistics_company = _interopRequireDefault(
  require('../models/logistics_company')
)
        ...
        while (1) {
          switch ((_context.prev = _context.next)) {
            case 0:
              ...
              if (!(0, _RoleService.checkIfLogisticsSuperAdmin)(role.name)) {
                _context.next = 9
                break
              }
        ...
        while (1) {
          switch ((_context3.prev = _context3.next)) {
            ...
            case 4:
              ...
              if (!(0, _RoleService.checkIfLogisticsAdmin)(role.name)) {
                _context3.next = 17
                break
              }
