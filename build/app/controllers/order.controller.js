...
var _calculated_order = _interopRequireDefault(
  require('../models/calculated_order')
)
            ...
            case 13:
              ...
              return _context2.abrupt(
                ...
                res.status(404).json({
                  ...
                  errors: {
                    cokitchen_polygon: [
                      'cokitchen_polygon not found id:'.concat(
                        cokitchen_polygon
                      )
                    ]
                  }
            ...
            case 37:
              return _context2.abrupt(
                ...
                res.status(404).json({
                  ...
                  errors: {
                    addon: [
                      'addon not found meal-index:'
                        .concat(i, ', addon-index:')
                        .concat(j, ' addon-id:')
                        .concat(body.meal_details[i].addons[j].addon_id)
                    ]
                  }
                })
              )
            ...
            case 57:
              return _context2.abrupt(
                ...
                res.status(404).json({
                  ...
                  errors: {
                    meal: [
                      'meal not found meal-index:'
                        .concat(i, ' meal-id:')
                        .concat(body.meal_details[i].meal_id)
                    ]
                  }
                })
              )
