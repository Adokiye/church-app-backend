...
var _CokitchenValidator = _interopRequireWildcard(
  require('./cokitchen-validator')
)

exports.CokitchenValidator = _CokitchenValidator

var _CokitchenPolygonValidator = _interopRequireWildcard(
  require('./cokitchen-polygon-validator')
)
...
var _LogisticsValidator = _interopRequireWildcard(
  require('./logistics-validator')
)
