...
router.post('/posist/order/dispatched/:order_code', Order.kitchenDispatchOrder)
...
router.get('/card/charge', UserCardValidator.chargeCardWallet(), UserCard.chargeCardForWallet)
